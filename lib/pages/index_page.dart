...
import 'package:pks_5/pages/add_product_screen.dart';
import 'package:pks_5/pages/item_page.dart';

class IndexPage extends StatefulWidget {
  final Function(Product) onProductAdded;
  final List<Product> favoriteProducts;

  IndexPage({required this.onProductAdded, required this.favoriteProducts});
...
class _IndexPageState extends State<IndexPage> {
  ...
  // Метод добавления или удаления товара из избранного
